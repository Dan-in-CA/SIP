...
#     u"pwd": u"b3BlbmRvb3I=",
    ...
    u"theme": u"basic",
    u"show": [255],
#     u"salt": u"sZJ@LZ^!w1NGG|qg_zz>X\\jMR2#L#0e#Io[9gjW?'Ek:[Q087izk~\\{8!>/)27{}",
    u"password": u"e74a224d3277c87785d284286f230ae5f5ee940d",
    u"lang": u"default",
    u"idd": 0,
    u"pigpio": 0,
    u"alr": 0,
...
options = [
    ...
    [
        ...
        u"boolean",
        u"upas",
        _(u"Prevent anonymous users from accessing the system without a password. Minimal security"),
        _(u"Security"),
    ],
    [
        ...
        u"password",
        u"opw",
        _(u"Re-enter the current password. Defalut is opendoor"),
        _(u"Security"),
    ],
    [
        _(u"New password"),
